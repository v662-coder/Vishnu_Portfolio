...
export const projectCategories = ['All', 'MERN', 'React', 'JavaScript', 'Backend', 'AI']
...
export const projects = [
  {
    ...
    features: ['JWT + OTP authentication', 'Razorpay payment integration', 'Cloudinary media storage', 'Optimized with lazy loading'],
    github: '',
  ...
  },
  {
    ...
    features: ['Role-based access (admin/teacher/student)', 'Public & private CRUD views', 'Analytics & activity dashboard'],
    github: '',
  ...
  },
  {
    ...
    features: ['Real-time messaging & notifications', 'Job listing marketplace', 'Social feed (posts, likes, comments)'],
    github: '',
  ...
  },
  {
    ...
    features: ['Student record management', 'Company interview scheduling', 'Server-rendered EJS views'],
  ...
  },
  {
    ...
    features: ['AI-generated note summaries', 'Semantic search across notes', 'Laravel + React full-stack'],
  ...
  },
  {
    ...
    tech: ['Python'],
    features: ['Email-to-accounts lookup', 'OSINT reconnaissance tooling', 'GNU GPL v3.0 licensed'],
  ...
  },
  {
    ...
    tech: ['React', 'Sanity'],
    features: ['Sanity-powered product management', 'Cart & checkout flow', 'Animated UI'],
    github: 'https://github.com/v662-coder/E-Commerce/tree/master',
    live: '',
    caseStudy: '',
  },
  {
    ...
    features: ['Canvas-based game rendering', 'Keyboard controls', 'Score tracking'],
  ...
  },
  {
    ...
    description: 'A front-end hotel booking site built with HTML, CSS and JavaScript for interactive features.',
  ...
  },
  {
    ...
    features: ['City-based weather search', 'Temperature, humidity & feels-like data'],
  ...
  },
  {
    ...
    description: 'A multiple-choice quiz game for testing and building knowledge, for fun or educational use.',
  ...
  },
  {
    ...
    features: ['Auto-generated resume layout', 'Editable sections in real time'],
  ...
  },
  {
    ...
    description: 'A 2D platformer where the character avoids obstacles and jumps between suspended platforms.',
...
export const services = [
  { title: 'MERN Development', desc: 'End-to-end web apps built on MongoDB, Express, React and Node.js.' },
  { title: 'React Frontend', desc: 'Fast, accessible, component-driven UIs with clean state management.' },
  { title: 'Backend APIs', desc: 'Secure, well-documented REST APIs designed to scale.' },
  { title: 'Authentication Systems', desc: 'JWT auth, RBAC, and session security done right.' },
  { title: 'Real-time Applications', desc: 'Socket.IO powered chat, notifications and live dashboards.' },
  { title: 'Admin Dashboards', desc: 'Data-dense, role-aware admin panels that are pleasant to use.' },
  { title: 'SEO Optimization', desc: 'Technical and on-page SEO tuned for real search visibility.' },
  { title: 'Landing Pages', desc: 'Conversion-focused landing pages with premium motion design.' },
  { title: 'E-commerce Development', desc: 'Storefronts, checkout flows and admin tooling for online stores.' },
  { title: 'Performance Optimization', desc: 'Faster load times, smaller bundles, better Core Web Vitals.' },
]

export const whyHireMe = [
  { title: 'Clean Code', desc: 'Readable, maintainable, well-structured code — every time.' },
  { title: 'Responsive UI', desc: 'Pixel-perfect across mobile, tablet and desktop.' },
  { title: 'Fast Performance', desc: 'Optimized bundles and lazy-loaded assets.' },
  { title: 'API Integration', desc: 'Comfortable wiring up any third-party or internal API.' },
  { title: 'SEO Friendly', desc: 'Built with search visibility in mind from day one.' },
  { title: 'Authentication', desc: 'Secure JWT-based auth and role management.' },
  { title: 'Scalable Architecture', desc: 'Systems designed to grow with the product.' },
  { title: 'Deployment Experience', desc: 'Comfortable shipping to Vercel, Netlify and cloud servers.' },
]
...
export const testimonials = [
  ...
  },
  {
    ...
    quote: 'Placeholder testimonial — replace with a real quote about delivery speed and code quality.',
    avatar: '/testimonials/avatar-2.jpg',
  },
  {
    name: 'Client Name',
    role: 'CTO, Company',
    quote: 'Placeholder testimonial — replace with a real quote about communication and reliability.',
