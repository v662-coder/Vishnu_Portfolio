...
export const projects = [
  {
  ...
  },
   {
    ...
    title: "SRL Transport",
    category: ["MERN", "AI"],
    image: "/projects/srl-transport.jpg",
    description:
      "A full-stack transport business platform with a public customer website, admin dashboard and real-time AI chatbot. Customers can book transport services, get price estimates and track bookings, while owners and staff manage bookings, fleet, drivers and payments from a centralized dashboard.",
    tech: [
      "React",
      "Vite",
      "Node.js",
    ...
    features: [
      "Customer booking and price estimation",
      "Booking and transport tracking",
      "Admin dashboard for bookings, fleet and drivers",
      "Payment management",
      "Role-based protected routes",
      "Real-time AI customer support chatbot",
      "Human handoff when AI cannot resolve a query",
      "Socket.IO real-time two-way communication",
      "Revenue and payment-status analytics",
      "Responsive public website and admin dashboard",
    ],
    github: "https://github.com/v662-coder/SRL-transport",
    live: "https://srl-transport.vercel.app/",
    caseStudy: "",
  },
  {
    id: "smartpost",
